Shader "PSX/PSXTerrain"
{
    ...
    Dependency "AddPassShader" = "Hidden/PSX/PSXTerrain (Add Pass)"
    Dependency "BaseMapShader" = "Hidden/PSX/PSXTerrain (Base Pass)"
    Dependency "BaseMapGenShader" = "Hidden/PSX/PSXTerrain (Basemap Gen)"

    CustomEditor "HauntedPSX.RenderPipelines.PSX.Editor.PSXTerrainShaderGUI"
}
